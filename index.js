...
{
    cardIndx = Math.floor(Math.random() * (108 - 0 + 1) + 0)

    console.log(cardIndx)
    let randomCard = cards[cardIndx]
...
function getCardList(cardInfo)
{
    return {'name': cardInfo['name'], 'icon': cardInfo['icon'], 'elixer': cardInfo['elixir'], 'type':cardInfo['type'], 'rarity':cardInfo['rarity'], 'arena':cardInfo['arena']}
}
