cardsfromgithub = [
    [
        ...
        },
        {
            "key": "terry",
            "name": "Terry",
            "sc_key": "SuperHogRiderTerry",
            "elixir": 4,
            "type": "Troop",
            "rarity": "Champion",
            "arena": 16,
            "description": "Terry and his trusty companion Pim Pim bring their unconventional Hog Riding skills to the Arena!",
            "id": 26000081,
            "evolved_spells_sc_key": "",
            "is_evolved": false
        },
        ...
        },
        {
            ...
            "rarity": "Legendary",
            "arena": 12,
            "description": "This mystical creature will be reborn as an egg when destroyed. If it hatches, it returns to the fight! What an egg-cellent ability.\n\nBeing born again is tiring, so a hatched Phoenix will have slightly less Hitpoints and Damage (80% of its total).",
            "id": 26000087,
            "evolved_spells_sc_key": "",
            "is_evolved": false
        },
...
cardsfromgithub = cardsfromgithub[0]
...
// for (var x = 0; x < cardsfromgithub.length; x++)
// {
//     for (var y = 0; y < cardsWithImagesApi.length; y++)
//     {
//         if(cardsfromgithub[x]['name'] == cardsWithImagesApi[y]['name'])
//         {
//             // console.log(cardsfromgithub[x]['name'] + ' ' + cardsWithImagesApi[y]['name'])
//             // console.log(cardsWithImagesApi[y]['iconUrls']['medium'])
//             // console.log(x)
//             cardsfromgithub[x]['icon'] = cardsWithImagesApi[y]['iconUrls']['medium']
//         }
//     }
// }
// // console.log(cardsfromgithub)
// finalList = []
// for (var z = 0; z < cardsfromgithub.length; z++)
// {
//     if(cardsfromgithub[z]['icon'])
//     {
//         // console.log('image')
//         finalList.push(cardsfromgithub[z])
//     }else{
//         // console.log('noimage')
//     }
// }
// // console.log(finalList)
// // console.log(cardsfromgithub.length)
// // console.log(finalList.length)


// newL = []
// for (n = 0; n < finalList.length; n++)
// {
//     nameVal = finalList[n]['name']
//     '<option value="'+nameVal+'">'+nameVal+'</option> '
//     newL.push('<option value="'+nameVal+'">'+nameVal+'</option>')
// }
// console.log(newL)
...
//   "<option value=\"Mini P.E.K.K.A\">Mini P.E.K.K.A</option>",
...
//   "<option value=\"Lava Hound\">Lava Hound</option>",
...
//   "<option value=\"Elite Barbarians\">Elite Barbarians</option>",
//   "<option value=\"Hunter\">Hunter</option>",
//   "<option value=\"Executioner\">Executioner</option>",
//   "<option value=\"Bandit\">Bandit</option>",
//   "<option value=\"Royal Recruits\">Royal Recruits</option>",
...
//   "<option value=\"Wall Breakers\">Wall Breakers</option>",
...
//   "<option value=\"Goblin Cage\">Goblin Cage</option>",
...
//   "<option value=\"Giant Snowball\">Giant Snowball</option>",
//   "<option value=\"Royal Delivery\">Royal Delivery</option>"
// ]

// l = document.querySelectorAll('[data-key]');
// iList = []
...
//     if(i.className == 'stat')
//     {
//         if(i.dataset.key == 'targets')
//         {
//           console.log(i.children[1].children[1].innerHTML)
//         }
//     }
// }
...
// {
//   try{
//     n = document.getElementsByClassName('row-'+(x + 2)+' even')[0].children[0].innerHTML.split('> ')[1]
//     t = document.getElementsByClassName('row-'+(x + 2)+' even')[0].children[9].innerHTML
//   }catch{
//     n = document.getElementsByClassName('row-'+(x + 2)+' odd')[0].children[0].innerHTML.split('> ')[1]
//     t = document.getElementsByClassName('row-'+(x + 2)+' odd')[0].children[9].innerHTML
//   }

  
//   console.log({'name': n, 'target': t})
//     l.push({'name': n, 'target': t})
// }
...
// {
//     cardN = cards[x]['name']
//     for (y = 0; y < targetsListNotAllCards.length; y++)
//     {
//         cardNY = targetsListNotAllCards[y]['name']

//         if(cardN.toLowerCase() == cardNY.toLowerCase()) // card found
//         {
//             cards.splice(x, 1);
//         }
//     }
...
// const commonCards = [
//   { name: "Barbarian", target: "Ground" },
//   { name: "Spear Goblin", target: "Air & Ground" },
//   { name: "Goblin", target: "Ground" },
//   { name: "Archers", target: "Air & Ground" },
//   { name: "Skeleton Army", target: "Ground" },
//   { name: "Goblin Barrel", target: "All" },
//   { name: "Bomber", target: "Ground" },
//   { name: "Barbarians", target: "Ground" },
//   { name: "Knight", target: "Ground" },
//   { name: "Giant Skeleton", target: "All" },
//   { name: "Skeleton Barrel", target: "All" },
//   { name: "Flying Machine", target: "Air & Ground" },
//   { name: "Hunter", target: "Air & Ground" },
//   { name: "Miner", target: "Buildings" },
//   { name: "Goblin Drill", target: "All" },
//   { name: "Valkyrie", target: "Ground" },
//   { name: "Skeleton Dragons", target: "Air" },
//   { name: "Ram Rider", target: "All" },
//   { name: "Zap", target: "All" },
//   { name: "Log", target: "Ground" },
//   { name: "Rage", target: "Your Troops" },  // Note: "Your Troops" retained as it's a unique target type
//   { name: "Cannon", target: "Ground" },
//   { name: "Bomb Tower", target: "Ground" }
// ];
// const rareCards = [
//   { name: "Mini P.E.K.K.A.", target: "Ground" },
//   { name: "Goblin Giant", target: "Ground" },
//   { name: "Musketeer", target: "Air & Ground" },
//   { name: "Wizard", target: "Air & Ground" },
//   { name: "Electro Wizard", target: "Air & Ground" },
//   { name: "Baby Dragon", target: "Air & Ground" },
//   { name: "Minion Horde", target: "Air" },
//   { name: "Mega Knight", target: "Ground" },
//   { name: "Electro Giant", target: "Ground" },
//   { name: "Bandit", target: "Ground" },
//   { name: "Mother Witch", target: "All" },
//   { name: "Hunter Giant", target: "Ground" },
//   { name: "Canon Cart", target: "All" },
//   { name: "Flying Barrel", target: "All" },
//   { name: "Skeleton King", target: "Air & Ground" },
//   { name: "Fisherman", target: "Ground" },
//   { name: "Archer Queen", target: "Air & Ground" },
//   { name: "Night Witch", target: "Ground" },
//   { name: "Battle Healer", target: "Your Troops" },  // Unique target
//   { name: "Zappies", target: "Ground" },
//   { name: "Tornado", target: "All" }
// ];

// const epicCards = [
//   { name: "Prince", target: "Ground" },
//   { name: "Bowler", target: "Ground" },
//   { name: "Battle Ram", target: "Buildings & All" },
//   { name: "Sparky", target: "Ground" },
//   { name: "P.E.K.K.A.", target: "Ground" },
//   { name: "Executioner", target: "Air & Ground" },
//   { name: "Golem", target: "Buildings & All" },
//   { name: "Elite Barbarians", target: "Ground" },
//   { name: "Graveyard", target: "All" },
//   { name: "Three Musketeers", target: "Air & Ground" },
//   { name: "Cannon", target: "Ground" },
//   { name: "Royal Giant", target: "Buildings" },
//   { name: "Goblin Hut", target: "All" },
//   { name: "Barb Hut", target: "All" },
//   { name: "Barbarian Barrel", target: "Buildings & All" },
//   { name: "Wall Breakers", target: "Buildings" },
//   { name: "Electro Spirit", target: "Ground" },
//   { name: "Poison", target: "All" },
//   { name: "Tornado", target: "All" }
// ];
// const legendaryCards = [
//   { name: "Night Witch", target: "Ground" },
//   { name: "Miner", target: "Buildings" },
//   { name: "Lumberjack", target: "Ground" },
//   { name: "Lava Hound", target: "Buildings & All" },
//   { name: "Electro Wizard", target: "Air & Ground" },
//   { name: "Sparky", target: "Ground" },
//   { name: "Inferno Dragon", target: "Buildings & Ground" },
//   { name: "Mega Knight", target: "Ground" },
//   { name: "Ram Rider", target: "Buildings & All" },
//   { name: "X-Bow", target: "Buildings & All" },
//   { name: "Mother Witch", target: "All" },
//   { name: "Ice Wizard", target: "Air & Ground" },
//   { name: "Princess", target: "Ground" },
//   { name: "Bandit", target: "Ground" },
//   { name: "Magic Archer", target: "Air & Ground" },
//   { name: "Fisherman", target: "Ground" },
//   { name: "Graveyard", target: "Ground" }
// ];

// const championCards = [
//   { name: "Golden Knight", target: "Ground" },
//   { name: "Archer Queen", target: "Air & Ground" },
//   { name: "Skeleton King", target: "Ground" },
//   { name: "Royal Champion", target: "Air & Ground" },
//   { name: "Monk", target: "Ground" }
// ];


 console.log(targetsListNotAllCards.length)